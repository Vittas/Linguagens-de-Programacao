def calculadora_de_troco ():
    ...
    price_table = {}
    price_table["feijão"] = 8.99
    price_table["arroz"] = 25.60

    if not qtd[1] in price_table:
        print("Erro") 
        return

    pagamento =  price_table[qtd[1]] * qtd[0]
    ...
    print(f"O preço total  da compra deu: {pagamento}")
