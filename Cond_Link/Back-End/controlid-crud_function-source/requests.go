...
func checkMiddlewareIsConnected(middlewareID string) (map[string]interface{}, error) {
	url := "http://alarm.condlink.com.br:9123/checkConnection"
	method := "POST"
	...
	// Adicionar cabeçalhos à solicitação
	req.Header.Add("Authorization", "Bearer 65e8b60d7b736")
	req.Header.Add("Content-Type", "application/json")
